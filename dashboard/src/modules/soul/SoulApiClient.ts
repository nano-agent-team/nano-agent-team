...
export interface SoulGoal { id: string; title: string; status: string; ideas: SoulIdea[]; }
export interface SoulIdea { id: string; title: string; status: string; conscience_verdict?: string; dialogue: DialogueTurn[]; plans: SoulPlan[]; }
export interface SoulPlan { id: string; title: string; status: string; tasks: SoulTask[]; }
